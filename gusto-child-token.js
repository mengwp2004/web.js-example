...
contract_address = "0x0f29b9e449748f51d1f9a6dcb0f6765fa6be8b61";
...
function issueToken(strAbi,contract_address){
    ...
    var hello =sigContractInstance.issueToken.call('gusto','gdm',total,9,mainHold);
   
    //var hello =sigContractInstance.issueToken.call(name:'gusto',symbol:'gdm',total:total,decimals:9,mainHold:mainHold);
    console.log(hello);
...
function getRelation(strAbi,contract_address){
   ...
   var hello =sigContractInstance.getRelation.call('gdm');
   console.log(hello);
}
...
function redeem(from,value){
   ...
   var hello =sigContractInstance.redeem.sendTransaction(from,'gdm',value,{from:from});
   console.log(hello);
}
...
//issueToken(strAbi,contract_address);
initializeContract(strAbi,contract_address);
...
//transfer(address,address1,1000000);
